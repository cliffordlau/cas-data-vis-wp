...
Of course there are others, such as maps to compare states, box plot and violin charts to show distributions, etc.
...
Slopegraphs can get cluttered, and should be avoided when there are too many overlapping lines.
...
![Horizontal Bar](choosing_pics/HORIZONTAL_BAR.PNG)
...
![Alternative Stacked Horizontal Bar](choosing_pics/ALTERNATIVE_STACKED_HORIZONTAL_BAR.PNG)
